  ...
  return (
    <section className="relative min-h-screen flex items-center pt-20 pb-32 overflow-hidden bg-black">
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          ...
          <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            <div className="mb-6 inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-blue-900/20 to-purple-900/20 border border-blue-700/20 backdrop-blur-md">
              ...
              <span className="text-sm font-medium text-blue-300">Technology Leaders Since 2010</span>
            </div>
            ...
            <div className="relative w-full max-w-lg">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="w-64 h-64 relative">
                  ...
                  <div className="w-full h-full absolute rounded-full border-4 border-transparent border-t-blue-500 border-r-purple-500 animate-spin-slow animate-pulse"></div>
              ...
              {/* Floating elements */}
              <div className="absolute top-1/4 -left-4 w-12 h-12 bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg blur-sm animate-float"></div>
              <div className="absolute bottom-1/4 right-8 w-20 h-20 bg-gradient-to-r from-purple-500 to-indigo-600 rounded-full blur-md animate-float animation-delay-1000"></div>
              <div className="absolute bottom-10 left-1/3 w-16 h-16 bg-gradient-to-r from-blue-400 to-indigo-500 rounded-md blur-sm animate-float animation-delay-2000"></div>
            </div>
          </div>
        </div>
        ...
        {/* Stats */}
        <div 
          className={`grid grid-cols-2 lg:grid-cols-4 gap-5 lg:gap-8 mt-24 transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
        >
          <div className="bg-gradient-to-r from-blue-900/10 to-purple-900/10 backdrop-blur-lg rounded-xl border border-blue-500/10 p-6 transform hover:scale-105 transition-all duration-300">
            <h4 className="text-4xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">500+</h4>
            <p className="text-gray-400 mt-2">Projects Delivered</p>
          </div>
          <div className="bg-gradient-to-r from-blue-900/10 to-purple-900/10 backdrop-blur-lg rounded-xl border border-blue-500/10 p-6 transform hover:scale-105 transition-all duration-300">
            <h4 className="text-4xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">99%</h4>
            <p className="text-gray-400 mt-2">Client Satisfaction</p>
          </div>
          <div className="bg-gradient-to-r from-blue-900/10 to-purple-900/10 backdrop-blur-lg rounded-xl border border-blue-500/10 p-6 transform hover:scale-105 transition-all duration-300">
            <h4 className="text-4xl font-bold bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">13+</h4>
